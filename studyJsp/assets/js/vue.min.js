...
!(function(e, t) {
        ...
        for (n in c)
          (r = s[n]),
            ...
            r
              ...
              : (lr(i, "bind", t, e), i.def && i.def.inserted && u.push(i));
        if (u.length) {
          var f = function() {
  ...
  function pr(e, r) {
    ...
    if (
      ...
      for (o in ((q || Z) && u.value !== c.value && dr(s, "value", u.value), c))
        t(u[o]) &&
          (Fn(o)
        ...
        e.data.show ||
          ...
          F &&
            ...
            Ti(function() {
              Ni(i, S),
                R.cancelled ||
                  (Ei(i, E), P || (Ri(I) ? setTimeout(R, I) : ji(i, c, R)));
            })),
  ...
  function ua(e, t) {
    ...
    function u(e) {
      if (
        ...
        i.length ||
          e === n ||
          (n.if && (e.elseif || e.else) && pa(n, { exp: e.elseif, block: e })),
        r && !e.forbidden)
      )
        if (e.elseif || e.else)
          (a = e),
          ...
          if (((r = i = u[t].name), (o = u[t].value), Zo.test(r)))
            if (
              ...
              (r = r.replace(ta, "")),
                ...
                (a && a.prop) || (!e.component && Jo(e.tag, e.attrsMap.type, r))
                  ? Tr(e, r, o, u[t], c)
                  : Er(e, r, o, u[t], c);
            else if (Wo.test(r))
              (r = r.replace(Wo, "")),
